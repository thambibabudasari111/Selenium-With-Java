...
public class FindElementVsFindElements {
	...
	public static void main(String[] args) {
		...
		//find element - if multiple elements present it return the first element from the list
		...
		//find elements - if element not present it doesn't throw any exception and returns zero elements
